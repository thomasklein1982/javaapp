<template>
  <div id="root">
    <Toast/>
    <div v-if="showStatementCount" style="text-align: right"><span :style="{color: statementCount>maxStatementCount? 'red':'lime'}">{{ statementCount }}</span> / {{ maxStatementCount }} Befehle</div>
