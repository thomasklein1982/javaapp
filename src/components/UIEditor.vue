...
<script>
  ...
  export default{
    ...
    data: function(){
      return {
        componentList: [
          {type: "JPanel", components: [], template: "1", onAction: false, actionCommand: "", onMouseUp: false, onMouseDown: false}, 
          {type: "JLabel", value: "JLabel", valueType: "html", onAction: false, actionCommand: "", align: "center", onMouseUp: false, onMouseDown: false},
          {type: "JButton", value: "JButton", valueType: "html", onAction: true, actionCommand: "", disabled: false, onMouseUp: false, onMouseDown: false},
          {type: "JTextField", inputType: "text", value: "", placeholder: "JTextField", valueType: "inline-text", onAction: false, actionCommand: "", disabled: false, onMouseUp: false, onMouseDown: false},
          {type: "JTextArea", value: "", placeholder: "JTextArea", valueType: "text", disabled: false, onMouseUp: false, onMouseDown: false}, 
          {type: "JCheckBox", value: true, label: "JCheckBox", valueType: "Boolean", onAction: true, actionCommand: "", disabled: false, onMouseUp: false, onMouseDown: false}, 
          {type: "JComboBox", value: "Ja", options: '["Ja","Nein","Vielleicht"]',valueType: "text", onAction: false, actionCommand: "", disabled: false, onMouseUp: false, onMouseDown: false}, 
          {type: "DataTable", onMouseUp: false, onMouseDown: false}, 
          {type: "JImage", value: "https://thomaskl.uber.space/Webapps/Assets/graphics/overworld/house-front.png", valueType: "text", onAction: false, actionCommand: "", onMouseUp: false, onMouseDown: false}, 
          {type: "Canvas", components: [], minX: 0, maxX: 100, minY: 0, maxY: 100, onAction: false, actionCommand: "", onMouseUp: true, onMouseDown: true, onMouseMove: true}, 
